...
var CACHE_KEY = require('./RelayGraphModeInterface').CACHE_KEY,
    DEFERRED_FRAGMENTS = require('./RelayGraphModeInterface').DEFERRED_FRAGMENTS,
    FRAGMENTS = require('./RelayGraphModeInterface').FRAGMENTS,
    REF_KEY = require('./RelayGraphModeInterface').REF_KEY,
    PUT_EDGES = require('./RelayGraphModeInterface').PUT_EDGES,
    PUT_NODES = require('./RelayGraphModeInterface').PUT_NODES,
    PUT_ROOT = require('./RelayGraphModeInterface').PUT_ROOT;
