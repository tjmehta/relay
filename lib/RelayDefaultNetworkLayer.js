...
var RelayDefaultNetworkLayer = function () {
  ...
  RelayDefaultNetworkLayer.prototype.sendSubscription = function sendSubscription(request) {
    require('fbjs/lib/invariant')(false, 'RelayDefaultNetworkLayer: `sendSubscription` is not implemented in the ' + 'default network layer.  A custom network layer must be injected.');
  };
